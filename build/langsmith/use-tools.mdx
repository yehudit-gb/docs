...
To add a tool to your prompt, click the `+ Tool` button at the bottom of the prompt editor. ![Add tool](/langsmith/images/add-tool.png)
...
![Tool choice](/langsmith/images/tool-choice.png)
