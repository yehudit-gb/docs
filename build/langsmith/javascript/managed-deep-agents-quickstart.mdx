...
import MdaQuickstartSearchToolProviderPy from '/snippets/javascript/code-samples/mda-quickstart-search-tool-provider-py.mdx';
import MdaQuickstartSearchToolProviderJs from '/snippets/javascript/code-samples/mda-quickstart-search-tool-provider-js.mdx';
