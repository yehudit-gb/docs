...
<Steps>
  <Step title="Navigate to Agent Builder">
    1. In the [LangSmith UI](https://smith.langchain.com), click <Icon icon="pointer"/> **Switch to Agent Builder** at the top of the left-hand navigation.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Try more templates" icon="layout-grid" href="/langsmith/agent-builder-templates">
  ...
  <Card title="Connect more tools" icon="puzzle" href="/langsmith/agent-builder-tools">
