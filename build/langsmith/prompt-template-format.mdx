...
Use the [prompt playground](https://smith.langchain.com/playground) to test out the examples on this page. Switch the **Prompt format** under the prompt settings <Icon icon="settings" color="#4F46E5" iconType="solid" /> menu in the Playground.
</Callout>
