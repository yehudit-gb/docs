---
title: "Python interpreter integration"
description: "Integrate with the Python interpreter tool using LangChain JavaScript."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/tools/pyinterpreter.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
