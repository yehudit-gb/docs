---
title: "VectorStoreToolkit integration"
description: "Integrate with the VectorStoreToolkit tool using LangChain JavaScript."
---
...
If you want to get automated tracing from runs of individual tools, you can also set your [LangSmith](https://docs.langchain.com/langsmith/home) API key by uncommenting below:
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/tools/vectorstore.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
