---
title: "Mozilla/readability integration"
description: "Integrate with the Mozilla/readability document transformer using LangChain JavaScript."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/document_transformers/mozilla_readability.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
