---
title: "Html-to-text integration"
description: "Integrate with the Html-to-text document transformer using LangChain JavaScript."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/document_transformers/html-to-text.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
