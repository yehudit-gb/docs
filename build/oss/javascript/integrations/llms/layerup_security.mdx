---
title: "Layerup security integration"
description: "Integrate with the Layerup security LLM using LangChain JavaScript."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/llms/layerup_security.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
