---
title: "Webpages, with playwright integration"
description: "Integrate with the Webpages, with playwright document loader using LangChain JavaScript."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/document_loaders/web_loaders/web_playwright.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
