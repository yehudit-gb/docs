---
title: "ByteDanceDoubaoEmbeddings integration"
description: "Integrate with the ByteDanceDoubaoEmbeddings embedding model using LangChain JavaScript."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/text_embedding/bytedance_doubao.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
