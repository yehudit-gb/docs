...
description: "Integrate with the Typesense vector store using LangChain JavaScript."
---
...
- `constructor(embeddings: Embeddings, config: TypesenseConfig)`: Constructs a new instance of the `Typesense` class.
  - `embeddings`: An instance of the [`Embeddings`](https://reference.langchain.com/javascript/classes/_langchain_core.embeddings.Embeddings.html) class used for embedding documents.
