---
title: "Zep open source integration"
description: "Integrate with the Zep open source vector store using LangChain JavaScript."
---
...
low-latency embedding models. Since LangChain requires passing in a [`Embeddings`](https://reference.langchain.com/javascript/classes/_langchain_core.embeddings.Embeddings.html) instance, we pass in `FakeEmbeddings`.

**Note:** If you pass in an [`Embeddings`](https://reference.langchain.com/javascript/classes/_langchain_core.embeddings.Embeddings.html) instance other than `FakeEmbeddings`, this class will be used to embed documents.
