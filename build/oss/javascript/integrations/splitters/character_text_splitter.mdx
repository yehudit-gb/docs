...
- `.createDocuments` — returns LangChain [Document](https://reference.langchain.com/javascript/classes/_langchain_core.documents.Document.html) objects, useful when metadata needs to be preserved for downstream tasks.
