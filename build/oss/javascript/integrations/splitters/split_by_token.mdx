...
We can use `tiktoken` to estimate tokens used using [TokenTextSplitter](https://reference.langchain.com/javascript/classes/_langchain_textsplitters.TokenTextSplitter.html). It will probably be more accurate for OpenAI models.
