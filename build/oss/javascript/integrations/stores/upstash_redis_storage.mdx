...
description: "Integrate with the Upstash Redis store using LangChain JavaScript."
---

This example demonstrates how to setup chat history storage using the `UpstashRedisStore` [`BaseStore`](https://reference.langchain.com/javascript/classes/_langchain_langgraph-checkpoint.BaseStore.html) integration.
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/stores/upstash_redis_storage.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
