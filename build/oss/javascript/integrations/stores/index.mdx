...
You can also implement your own custom store by extending the [`BaseStore`](https://reference.langchain.com/javascript/classes/_langchain_langgraph-checkpoint.BaseStore.html) class. See the [store interface documentation](https://api.js.langchain.com/classes/langchain_core.stores.BaseStore.html) for more details.
