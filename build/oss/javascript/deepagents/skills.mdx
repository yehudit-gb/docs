...
{/* When using the [Deep Agents CLI](/oss/javascript/deepagents/data-locations), the precedence order from lowest to highest is:
...
For more details on file locations and precedence, see [App data](/oss/javascript/deepagents/data-locations). */}
