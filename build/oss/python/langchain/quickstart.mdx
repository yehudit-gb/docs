...
<Steps>
    ...
    <Step title="Create tools">
        ...
        <Tip>
            ...
            LangChain's [`@tool` decorator](https://reference.langchain.com/python/langchain/tools/#langchain.tools.tool) adds metadata and enables runtime injection with the `ToolRuntime` parameter.
        </Tip>
