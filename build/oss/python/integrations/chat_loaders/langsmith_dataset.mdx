---
title: "LangSmith chat datasets integration"
description: "Integrate with the LangSmith chat datasets chat loader using LangChain Python."
---
...
This notebook fine-tunes a model directly on selecting which runs to fine-tune on. You will often curate these from traced runs. You can learn more about LangSmith datasets in the docs [docs](https://docs.langchain.com/langsmith/evaluation#datasets).
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/chat_loaders/langsmith_dataset.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
