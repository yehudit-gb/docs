---
title: "Embedding documents using optimized and quantized embedders integration"
description: "Integrate with the Embedding documents using optimized and quantized embedders embedding model using LangChain Python."
---
