---
title: "Google generative AI (AI studio & Gemini API) integration"
sidebarTitle: GoogleGenerativeAIEmbeddings
description: "Integrate with the Google generative AI (AI studio & Gemini API) embedding model using LangChain Python."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/text_embedding/google_generative_ai.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
