---
title: "Textembed - embedding inference server integration"
description: "Integrate with the Textembed - embedding inference server embedding model using LangChain Python."
---
