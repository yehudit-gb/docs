...
To enable automated tracing of individual tools, set your [LangSmith](https://docs.langchain.com/langsmith/home) API key:
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/tools/sql_database.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
