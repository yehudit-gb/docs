---
title: "Momento vector index (Mvi) integration"
sidebarTitle: "Momento Vector Index (MVI)"
description: "Integrate with the Momento vector index (Mvi) vector store using LangChain Python."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/vectorstores/momento_vector_index.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
