---
title: "China mobile ecloud elasticsearch vectorsearch integration"
description: "Integrate with the China mobile ecloud elasticsearch vectorsearch vector store using LangChain Python."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/vectorstores/ecloud_vector_search.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
