...
description: "Integrate with the Google Vertex AI vector search vector store using LangChain Python."
---
...
- [Vector Search 2.0](#vector-search-20) - If you're using Collections
- [Vector Search 1.0](#vector-search-10) - If you're using Indexes and Endpoints
