---
title: "PolarisAIDataInsightLoader integration"
description: "Integrate with the PolarisAIDataInsightLoader document loader using LangChain Python."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/polaris_ai_datainsight.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
