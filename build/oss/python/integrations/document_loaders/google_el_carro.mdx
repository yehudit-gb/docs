---
title: "Google el carro for Oracle workloads integration"
description: "Integrate with the Google el carro for Oracle workloads document loader using LangChain Python."
---
