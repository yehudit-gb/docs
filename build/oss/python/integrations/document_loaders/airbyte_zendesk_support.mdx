---
title: "Airbyte zendesk support (Deprecated) integration"
description: "Integrate with the Airbyte zendesk support (Deprecated) document loader using LangChain Python."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_loaders/airbyte_zendesk_support.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
