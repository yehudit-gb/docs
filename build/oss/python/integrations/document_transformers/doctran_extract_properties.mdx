---
title: "Doctran extract properties integration"
description: "Integrate with the Doctran extract properties document transformer using LangChain Python."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/document_transformers/doctran_extract_properties.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
