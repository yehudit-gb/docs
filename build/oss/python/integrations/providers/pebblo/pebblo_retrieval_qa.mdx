---
title: "Identity-enabled RAG using pebbloretrievalqa integrations"
description: "Integrate with Identity-enabled RAG using pebbloretrievalqa using LangChain Python."
---
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/providers/pebblo/pebblo_retrieval_qa.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
