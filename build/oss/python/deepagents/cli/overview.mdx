...
<Steps>
    <Step title="Set your API key" icon="key">
        ...
        <Note>
            ...
            For more information see [Additional installation and configuration options](/oss/python/deepagents/cli/overview#additional-installation-and-configuration-options).
        </Note>
    </Step>
